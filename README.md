...
2. 在 `~/.claude/settings.json` 中注册 `Stop` 和 `Notification` 两个 hook
...
- **Two notifications** — Task completed ✅ / Needs your input 🔔
...
2. Registers `Stop` and `Notification` hooks in `~/.claude/settings.json`
